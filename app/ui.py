...
def render_result(st, result: PredictionResult) -> None:
    ...
    st.markdown(
        ...
        <p class="fineprint">Final prediction combines the three frozen ensemble members.</p></section>''',
...
def render_model_outputs(st, result: PredictionResult) -> None:
    ...
    labels = {**MODEL_LABELS, "ensemble": "Final Ensemble"}
...
def render_about(st) -> None:
    with st.expander("About this model"):
        st.markdown("""This research demo uses a frozen PyTorch ensemble of ConvNeXt-Tiny, EfficientNetV2-S, and multimodal DINOv2. The multimodal member accepts optional age, sex, and anatomical-site metadata.
...
**Independent DDI external test:** N = 656 · ROC-AUC 0.721 · Macro-F1 0.651 · Sensitivity 57.3% · Specificity 75.9%. These ensemble results are from ConvNeXt-Tiny, EfficientNetV2-S, and multimodal DINOv2. External testing revealed substantial domain shift, particularly for malignant-lesion sensitivity.""")
